            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    if (task.getResult().exists()) {
                        ...
                        Glide.with(SetupProfileActivity.this).setDefaultRequestOptions(placeholderReq).load(img_profile).into(imgSetupImgProfile);
                    ...
                    Toast.makeText(SetupProfileActivity.this, "Upss, firestore error " + errorMessage, Toast.LENGTH_SHORT).show();
        ...
        imgSetupImgProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Build.VERSION.SDK_INT >= 21) {
                    ...
                    if (ContextCompat.checkSelfPermission(SetupProfileActivity.this,
